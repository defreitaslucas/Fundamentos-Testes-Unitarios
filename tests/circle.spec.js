...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(Object.keys(circle(1)).lenght),3;
    // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
    expect(circle('')).toBeUndefined();
    // Teste que a função retorna, dentro de um objeto, a circunferência correta para um círculo de raio 2.
    expect(circle(2).circumference).toBe(12.56);
    // Teste que a função retorna, dentro de um objeto, a área correta para um círculo de raio 3.
    // utilizei o matcher tobecloseto retirado da documentação oficial do jest https://jestjs.io/pt-BR/docs/using-matchers pois ele se aproxima do resultado.
